...
var instrucciones = [
  "El juego consiste en armar el rompecabeza a la forma original",
  "Las piezas se mueven con las flechas del teclado , arriba , abajo ,izquierda derecha",
  "Haz clic sobre el botón para comenzar el juego"
];
